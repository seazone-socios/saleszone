  ...
  try {
    ...
    const [metaRes, metaAllRes, countsRes, crossWonRes] = await Promise.all([
      ...
      supabase
        ...
        .limit(10000),
      // TODO: MKTP may need its own RPC for emp counts summary
      supabase.rpc("get_mktp_emp_counts_summary", { p_start_date: startDate }),
      supabase.rpc("get_mktp_ad_won_cross_emp"),
    ]);
    ...
    console.error("MKTP Campanhas error:", error);
